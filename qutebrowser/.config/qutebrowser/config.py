...
config.bind(
    ",g",
    "config-cycle content.user_stylesheets ~/repo/solarized-everything-css/css/gruvbox/gruvbox-all-sites.css ''",
)
config.bind(
    ",a",
    "config-cycle content.user_stylesheets ~/repo/solarized-everything-css/css/darculized/darculized-all-sites.css  ''",
)
...
c.content.headers.user_agent = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/92.0.4515.159 Safari/537.36"
...
c.url.default_page = "/home/mostafa/.config/default_page_browser/index.html"
...
c.url.searchengines = {
    ...
    "db": "https://wiki.debian.org/?action=fullsearch&value={}",
    "vi": "https://vim.fandom.com/wiki/Special:Search?query={}&scope=internal&contentType=&ns%5B0%5D=0",
    "yt": "https://www.youtube.com/results?search_query={}",
    "gt": "https://github.com/search?q={}&type=Repositories",
    "di": "https://www.ldoceonline.com/dictionary/{}",
}

## Page(s) to open at the start.
## Type: List of FuzzyUrl, or FuzzyUrl
c.url.start_pages = ["file:///home/mostafa/.config/default_page_browser/index.html"]
...
config.bind(",b", "config-cycle colors.webpage.bg '#1d2021' 'white'")
...
config.bind(";Q", "spawn alacritty -e youtube-dl -f22 {url}")
config.bind(";q", "hint links spawn alacritty -e yt-dlp -f b {hint-url}")
config.bind(";V", "spawn  ~/.config/qutebrowser/scripts/open_youtube_video.sh  {url}")
config.bind(
    ";v",
    "hint links spawn ~/.config/qutebrowser/scripts/open_youtube_video.sh {hint-url}",
)
config.bind(";p", "hint links spawn ~/.config/qutebrowser/scripts/p_mpv {hint-url}")
config.bind(";P", "spawn ~/.config/qutebrowser/scripts/p_mpv {url}")
